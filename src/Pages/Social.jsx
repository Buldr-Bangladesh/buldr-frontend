  ...
  return (
    <div className='pb-20 dark:bg-slate-900'>
      ...
      {width <= 600 &&  <div className='flex z-10 md:hidden justify-center w-screen h-20 bg-gray-100 dark:bg-slate-800 fixed top-0' style={{alignItems:"center"}}>
        ...
        <h2 className='text-xl font-bold text-black font-title dark:text-gray-100'><span className='text-primary-500'>BULDR.</span> Social</h2>
        
      </div>}

      <div className="min-h-screen bg-base flex flex-wrap flex-col md:flex-row font-primary dark:bg-slate-900 mt-20 md:mt-0" style={{ alignItems: "center", justifyContent: "center" }}>
