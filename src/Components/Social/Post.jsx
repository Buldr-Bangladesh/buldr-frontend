...
import { API_ENDPOINT_FRONT, BASE_URL } from '../../Data/apiData'
  ...
  return (
    <article class="p-6 bg-white max-w-xl mx-5 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      {!loading && <div class="flex items-center mb-2 space-x-4">
          ...
          <a href={API_ENDPOINT_FRONT+"/portfolio/"+user.userID} target='_blank'><span class="font-medium dark:text-white">
            {user.name}
          </span> </a>
        </div>}
        {loading && <div><Spinner/>Loading user... </div>}
